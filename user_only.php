...
if(isset($_POST['simpan'])){
	...
	$values = "'$kd','$user','$jk','$alamat','$email','$telp','$username','$pass','User','$tgl'";
	$statement->insert($table,$values,"pegawai=tambah_user");
...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 style="color:#2243B6"><span class="fa fa-user"></span> Kelola Data User</h3>
		</div>
		<div class="panel-body">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="number" name="no_telp" value="" placeholder="" class="form-control" required="" id="telp" autocomplete="off">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea name="alamat" id="" cols="20" rows="10" class="form-control" autocomplete="off"></textarea>
				</div>
			</div>
		</div>
		<hr>
			
			<button type="submit" class="btn btn-primary" name="simpan" style="margin-left:85%;margin-bottom:2%" id="simpan" sty>Simpan <span class="fa fa-save"></span></button>
